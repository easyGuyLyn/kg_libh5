...
public class InstallUtils {
    ...
    private static final String TAG = "regus InstallUtils ";
    private static com.regus.mj.utils.InstallUtils mInstance;
     ...
     * @return
     */
    public static com.regus.mj.utils.InstallUtils with(Context context) {
        mContext = context.getApplicationContext();
        if (mInstance == null) {
            mInstance = new com.regus.mj.utils.InstallUtils();
        }
        return mInstance;
    }
     ...
     * @return
     */
    public com.regus.mj.utils.InstallUtils setApkUrl(String apkUrl) {
        this.httpUrl = apkUrl;
        return mInstance;
    }
     ...
     * @return
     */
    public com.regus.mj.utils.InstallUtils setApkPath(String apkPath) {
     ...
     * @return
     */
    public com.regus.mj.utils.InstallUtils setCallBack(DownloadCallBack downloadCallBack) {
        mDownloadCallBack = downloadCallBack;
        return mInstance;
    }
...
//                .url(httpUrl)
//                .tag(com.regus.mj.utils.InstallUtils.class)
...
//        DownloadFileUtils.cancle(com.regus.mj.utils.InstallUtils.class);
//    }
    ...
    public static Intent getInstallIntent(Context context, String filePath){
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.N) {
            ...
            apkUri = com.regus.mj.utils.MNUpdateApkFileProvider.getUriForFile(context, authority, apkFile);
    ...
    private static String getFileProviderAuthority(Context context) {
        try {
            for (ProviderInfo provider : context.getPackageManager().getPackageInfo(context.getPackageName(), PackageManager.GET_PROVIDERS).providers) {
                if (
                     MNUpdateApkFileProvider.class.getName().equals(provider.name) &&
                        provider.authority.endsWith(".mn_update_apk.file_provider")) {
